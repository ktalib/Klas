-- Master script to run all table creation scripts in the correct order

-- Create instrument_registration table first
...
PRINT 'All instrument registration tables created successfully.';
