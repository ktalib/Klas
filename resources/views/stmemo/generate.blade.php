     ...
     <div class="max-w-6xl mx-auto bg-white shadow-lg rounded-lg p-8 border border-gray-200 mb-8">
          ...
          <form id="stMemoForm" action="{{ route('stmemo.save') }}" method="POST" class="space-y-6">
               ...
               <div class="flex items-center justify-end space-x-3 pt-5 border-t">
                    <a href="{{ route('stmemo.siteplan') }}" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                         Cancel
                    </a>
