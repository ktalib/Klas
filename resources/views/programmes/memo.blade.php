...
<div class="flex-1 overflow-auto">
    ...
    <div class="p-6 bg-gray-50 min-h-screen">
        <!-- Page Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Sectional Title Memo Management</h1>
            <p class="text-gray-600">Manage and generate sectional title memos for primary and unit applications</p>
        </div>
