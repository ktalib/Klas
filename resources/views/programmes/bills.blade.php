    ...
    <script>
        ...
        function getBalanceBillForm() {
            return `
                <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
                    <div class="p-4 border-b">
                        <h3 class="text-sm font-medium">Unit Application   Bill Balance</h3>
                        <p class="text-xs text-gray-500">Calculate, generate and preview   bill balance for unit applications</p>
                    </div>
