            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="p-4 border-b border-gray-200">
                    <div class="flex flex-wrap items-center justify-between">
                        <div>
                            <h5 class="text-lg font-semibold text-gray-800">{{ __('User Role List') }}</h5>
                        </div>
                            ...
                            <div>
                                <a href="#" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-md transition-colors customModal" 
                                    data-url="{{ route('user-roles.create') }}"
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                                {{ $role->level == 'system' ? 'bg-red-100 text-red-800' : 
                                                   ($role->level == 'management' ? 'bg-blue-100 text-blue-800' : 
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex space-x-2">
                                                    ...
                                                    <a href="#" class="text-green-600 hover:text-green-900 customModal" title="{{ __('Edit') }}" 
                                                       data-url="{{ route('user-roles.edit', $role->id) }}" data-title="{{ __('Edit User Role') }}">
