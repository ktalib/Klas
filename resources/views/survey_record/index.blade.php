        ...
        <div class="flex justify-between items-center mb-6">
          ...
          <div class="flex items-center space-x-4">
            <div class="relative inline-block text-left">
              <a href="{{ route('survey_record.create', ['is' => 'primary']) }}" class="flex items-center space-x-2 px-4 py-2 bg-green-700 text-white rounded-md hover:bg-green-800">
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody>
              ...
              <tr class="text-xs">
                ...
                <a href="{{ url('survey_record/update-survey/' . $survey->ID) }}" class="flex items-center px-3 py-1 text-xs bg-blue-600 text-white rounded-md hover:bg-blue-700">
