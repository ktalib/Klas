<div 
    ...
    class="action-menu">
    <a href="{{route('sectionaltitling.viewrecorddetail',$app->mother_id )}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" @click="open = false; openSingleRegisterModalWithData({{ $app->mother_id }})">
