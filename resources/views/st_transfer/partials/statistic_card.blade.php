...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
    <div class="bg-amber-50 p-4 rounded-lg shadow border-l-4 border-amber-500">
        <div class="text-sm font-medium text-amber-700 mb-1">Pending ST Transfered</div>
        <div class="text-2xl font-bold text-amber-800">{{ $pendingCount }}</div>
        <p class="text-xs text-amber-600 mt-1">awaiting ST transfer</p>
    </div>
    <div class="bg-green-50 p-4 rounded-lg shadow border-l-4 border-green-500">
        <div class="text-sm font-medium text-green-700 mb-1">ST Transfered</div>
        <div class="text-2xl font-bold text-green-800">{{ $registeredCount }}</div>
        <p class="text-xs text-green-600 mt-1">Successfully transfer</p>
    </div>
    ...
    <div class="bg-blue-50 p-4 rounded-lg shadow border-l-4 border-blue-500">
        <div class="text-sm font-medium text-blue-700 mb-1">Total ST transfers</div>
        <div class="text-2xl font-bold text-blue-800">{{ $totalCount }}</div>
        <p class="text-xs text-blue-600 mt-1">All sectional transfer</p>
    </div>
</div>
