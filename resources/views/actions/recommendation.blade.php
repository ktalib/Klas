                                    ...
                                    <div class="p-4 space-y-4">
                                                ...
                                                <div class="flex items-center space-x-4">
                                                    ...
                                                    <label class="inline-flex items-center">
                                                        <input type="radio" name="decision" value="approve"
                                                            class="form-radio" onchange="toggleReasonContainer(this)">
                                        ...
                                        <div class="grid grid-cols-1 gap-4">
                                            <div id="reasonContainer" class="space-y-2" style="display: none;">
                                                ...
                                                <textarea id="comments" rows="4" placeholder="Enter reason for declining"
                                                    class="w-full p-2 border border-gray-300 rounded-md text-sm"></textarea>
                                                <p class="text-xs text-red-500 mt-1">Please provide a reason for declining
                                                    this application</p>
                                            </div>
                                        </div>
