    ...
    <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
        ...
        <div class="p-4 space-y-4">
            ...
            <div class="flex gap-2">
                <button onclick="window.history.back()" class="flex items-center px-3 py-1 text-xs bg-white text-black p-2 border border-gray-500 rounded-md hover:bg-gray-800">
