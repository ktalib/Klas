        ...
        <div class="application-card">
                ...
                <div class="application-grid">
                    ...
                    @if(isset($motherApplication))
                        ...
                        <div class="application-field">
                            ...
                            <div class="field-value">{{ $motherApplication->property_plot_no ?? 'Not Assigned' }}</div>
                        </div>
                        
                        <div class="application-field">
                            <div class="field-label">District</div>
                            <div class="field-value">{{ $motherApplication->property_district ?? 'Not Specified' }}</div>
                        </div>
                        
                        <div class="application-field">
                            <div class="field-label">LGA</div>
                            <div class="field-value">{{ $motherApplication->property_lga ?? 'Not Specified' }}</div>
                        </div>
                    @endif
            ...
            @else
                ...
                <div class="application-grid">
                    ...
                    <div class="application-field">
                        <div class="field-label">Plot Number</div>
                        <div class="field-value">{{ $application->property_plot_no ?? 'Not Assigned' }}</div>
                    </div>
                    
                    <div class="application-field">
                        <div class="field-label">District</div>
                        <div class="field-value">{{ $application->property_district ?? 'Not Specified' }}</div>
                    </div>
